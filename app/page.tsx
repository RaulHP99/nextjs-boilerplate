    ...
    <main className="relative min-h-screen p-6 max-w-4xl mx-auto font-sans bg-gradient-to-b from-white via-zinc-50 to-white dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900">
      ...
      <section id="intro" className="flex flex-col md:flex-row md:items-center gap-8 my-12">
        <div className="md:w-1/2">
          ...
          <p className="mb-6 text-lg">
            Hello, I’m Raul Perez. This site is my Intro to Computer Science project, and
            I chose iOS Development because I’m passionate about building apps for Apple
            devices and hope to turn that passion into a career.
          </p>
        </div>
      ...
      <section id="why" className="flex flex-col md:flex-row-reverse md:items-center gap-8 my-12">
        <div className="md:w-1/2">
          ...
          <p className="mb-4">
            My dream job is to become an iOS Engineer. That dream started when I received
            my first iPod touch for my birthday. Ever since, I’ve loved how Apple blends
            creativity and technology to make life easier and more fun.
          </p>
        </div>
        <figure className="md:w-1/2">
          <Image
      ...
      <section id="what" className="flex flex-col md:flex-row md:items-center gap-8 my-12">
        <div className="md:w-1/2">
          ...
          <p className="mb-4">
            ...
            Xcode, and Apple’s developer tools, then publishing the finished app on the
            App Store.
          </p>
        </div>
        <figure className="md:w-1/2">
      ...
      <section id="how" className="flex flex-col md:flex-row md:items-center gap-8 my-12">
        <div className="md:w-1/2">
          ...
          <p className="mb-4">
            Idea → Plan → Build in Xcode → Test → Polish → Upload to App Store →
            Release.
          </p>
        </div>
        <figure className="md:w-1/2">
          <Image
            src="/lifecycle.jpg"
            alt="iOS app lifecycle timeline"
            width={1000}
            height={500}
            className="rounded-xl"
          />
      ...
      <section id="impact" className="flex flex-col md:flex-row-reverse md:items-center gap-8 my-12">
        <div className="md:w-1/2">
          ...
          <p className="mb-4">
            ...
            Learning to build them lets me solve real problems for real people.
          </p>
        </div>
        <figure className="md:w-1/2">
          <Image
